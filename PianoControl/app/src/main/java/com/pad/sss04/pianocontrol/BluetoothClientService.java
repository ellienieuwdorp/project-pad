...
public class BluetoothClientService {
    ...
    private static final String NAME_SECURE = "BluetoothClientSecure";
    private static final String NAME_INSECURE = "BluetoothClientSecure";
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(BluetoothClient.MESSAGE_DEVICE_NAME);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothClient.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
